...
도메인 주도 설계(DDD)의 전략적·전술적 패턴을 실용적인 관점에서 설명하는 책. 비즈니스 도메인 분석부터 이벤트스토밍까지, 실제 프로젝트에 DDD를 적용하는 방법을 다룬다.
...
- [x] [Chapter 4. Integrating Bounded Contexts](chapter-04.md)
...
### Part III. Applying Domain-Driven Design (DDD 적용)

- [ ] [Chapter 10. Design Heuristics](chapter-10.md)
- [ ] [Chapter 11. Evolving Design Decisions](chapter-11.md)
- [ ] [Chapter 12. EventStorming](chapter-12.md)
- [ ] [Chapter 13. Domain-Driven Design in the Real World](chapter-13.md)
